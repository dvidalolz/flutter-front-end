...
class _SurveyPageState extends State<SurveyPage> {
  ...
  Future<void> sendDataToBackend(
      SurveyData surveyData, String? userEmail) async {
    String apiUrl =
        "https://signupflow.azurewebsites.net/api/survey"; // Replace with your backend API URL
    Map<String, dynamic> surveyDataJson = surveyData.toJson();

    debugPrint(surveyDataJson.toString());
